 ...
 * 
 */
@WebServiceClient(name = "EstoqueWSService", targetNamespace = "http://caelum.com.br/estoquews/v1", wsdlLocation = "http://localhost:8080/casa-do-codigo-webservice/EstoqueWS?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/casa-do-codigo-webservice/EstoqueWS?wsdl");
